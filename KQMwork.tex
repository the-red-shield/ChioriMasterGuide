...
Our analysis reveals that C6 represents a 142\% damage increase over C0 when optimally built for on-field DPS. This considerable performance delta stems from:
...
\textbf{Optimal for:}
\begin{itemize}
    \item C0 Sub-DPS role (+2.5\% over Troupe)
